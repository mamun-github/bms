...
<head>
    ...
    <!-- bootstrap 3.0.2 -->
    <link href="<?=assets_url()?>css/lock/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- font Awesome -->
...
<div class="center">
    ...
    <div class="lockscreen-item">
        ...
        <div class="lockscreen-image">
            <img src="<?=assets_url()?>img/avatar.png" alt="user image"/>
        </div>
        <!-- /.lockscreen-image -->
    ...
    <div class="lockscreen-link">
        <a href="<?=base_url()?>">Or sign in as a different user</a>
    </div>
</div><!-- /.center -->
